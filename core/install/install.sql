...
CREATE TABLE IF NOT EXISTS tgstat_settings (
...
ALTER TABLE tgstat_settings
ADD UNIQUE INDEX UK_tgstat_settings_name (name);

CREATE TABLE IF NOT EXISTS tgstat_chat_subscribe_event (
  id bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS tgstat_chat (
  id bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS tgstat_admins (
  id bigint NOT NULL,
